...
const REQUEST_TOKEN_TYPS = ["credentialResponse"];
...
const MessageListener = ({openResponseTable}) => {
    ...
    return (
        <MessageList
            ...
            onClick={async (msg) => {
                ...
                KNOWN_TOKEN_TYPS.includes(msg.typ) && open(msg.message.token)
                REQUEST_TOKEN_TYPS.includes(msg.typ) && openResponseTable(msg.message.token)
